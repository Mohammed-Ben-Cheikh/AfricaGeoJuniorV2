...
<body>
    ...
    <div class="relative z-10 flex flex-col items-center justify-center w-full h-full bg-black/20">
    <h1 class="text-6xl bg-black/30 px-80  rounded-2xl py-4  text-white ">WORLDY</h1>
