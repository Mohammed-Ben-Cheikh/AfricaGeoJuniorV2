    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div class="bg-gradient-to-t from-blue-500/30 to-black border-b-2 p-8 rounded-lg shadow-md">
                <h2 class="text-center text-3xl font-bold text-white mb-8">Inscription</h2>
                ...
                <p class="mt-4 text-center text-sm text-white">
                    Déjà inscrit? 
                    <a href="login.php" class="font-medium text-white hover:text-indigo-500">Se connecter</a>
                </p>
            </div>
        </div>
    </div>
