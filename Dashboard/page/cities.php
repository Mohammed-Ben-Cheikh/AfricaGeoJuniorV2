    ...
    <section class="bg-white">
        <div class="py-8">
            <div class="flex items-center gap-4 ml-16">
                ...
                <a href="../../app/action/villes/add.php?id=<?php echo htmlspecialchars($_GET['id']); ?>"
                    ...
                    Add Cities <i class="ri-add-line"></i>
                </a>
            </div>
        </div>
        <?php if ($ville): ?>
                ...
                <div
                    ...
                    <div>
                        <div class=" flex justify-between items-center ">
                            ...
                            <div>
                                <a href="../../app/action/villes/edit.php?id=<?php echo htmlspecialchars($cities['id_ville']); ?>"><i
                                        class="ri-edit-fill text-sm text-black  hover:text-green-900 transform duration-300"></i></a>
                                <a href="../../app/action/villes/delete.php?id=<?php echo htmlspecialchars($cities['id_ville']); ?>"><i
